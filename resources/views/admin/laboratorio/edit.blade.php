			...
			<div class="col-md-12 ">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="container">
							<div class="row">
									{!! Form::open(['route'=>['laboratorio.update',$laboratorio],'method'=>'PUT','files'=>true]) !!}	  
									<div class="form-group col-md-6">
										{!! Form::label('title','Paciente')!!}
										{!!Form::select('paciente_id',$pacientes,$laboratorio->paciente_id,['class'=>'form-control select-paciente','required']) !!}
									</div>
									<div class="form-group col-md-6">
										{!! Form::label('title','Exámen')!!}
										{!!Form::select('examen_id',$examenes,$laboratorio->examen_id,['class'=>'form-control select-examen','required']) !!}
									</div>
									<div class="form-group col-md-6 ">
